...
import { INIT_SEARCH_OBJECT, LIST_STATUS_NV, STATUS_NV } from "../../constant";
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row: any, index: number) => <div>
        <div className={`status ${checkStatus(LIST_STATUS_NV,(Number(row?.trangThaiLaoDong) || STATUS_NV.DANG_LAM_VIEC))}`}></div>
      </div>
    },
    {
